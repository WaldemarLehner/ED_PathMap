...
window.addEventListener("keydown",function(e){
  let code = e.keyCode;
  if(this.keys.front === code){_areKeysPressed.front=true;}
  else if(this.keys.back === code){_areKeysPressed.back=true;}
  else if(this.keys.left === code){_areKeysPressed.left=true;}
  else if(this.keys.right === code){_areKeysPressed.right=true;}
  else if(this.keys.top === code){_areKeysPressed.top=true;}
  else if(this.keys.bottom === code){_areKeysPressed.bottom=true;}
});
window.addEventListener("keyup",function(e){
  let code = e.keyCode;
  if(this.keys.front === code){_areKeysPressed.front=false;}
  else if(this.keys.back === code){_areKeysPressed.back=false;}
  else if(this.keys.left === code){_areKeysPressed.left=false;}
  else if(this.keys.right === code){_areKeysPressed.right=false;}
  else if(this.keys.top === code){_areKeysPressed.top=false;}
  else if(this.keys.bottom === code){_areKeysPressed.bottom=false;}
});
//#endregion
...
if(dTime > 1000){ return; /*do nothing*/}
//console.log(dTime);
